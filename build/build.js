...
function condition_before_exports_property(raw) {
...
function restore_dynamic_import(raw) {
    ...
    while ((match_regexp = require_promise_regexp.exec(raw)) !== null) {
        ...
        console.log(`info restore dynamic import of ${module_name} from ${match_regexp.index} to ${require_promise_regexp.lastIndex}`);
    ...
    for (match_idx = 0; match_idx < matches.length; match_idx++) {
        ...
        out += (dynamic_import_before + match.module_name + dynamic_import_after
